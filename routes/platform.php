...
Route::group(['prefix' => 'authors', 'as' => 'authors.'], function () {
    Route::screen('/list', AuthorListScreen::class)->name('list');
    Route::screen('/{author?}', AuthorEditScreen::class)->name('edit');
});

// Model Book
Route::group(['prefix' => 'books', 'as' => 'books.'], function () {
    Route::screen('/list', BookListScreen::class)->name('list');
    Route::screen('/{book?}', BookEditScreen::class)->name('edit');
});
